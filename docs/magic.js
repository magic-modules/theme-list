...
var pages = {
  '/theme-list/': function themeList(state) {
    return [h1('@magic-modules/theme-list'), p(['this is the ', Link({
      to: 'https://github.com/magic-modules'
    }, '@magic-modules'), ' ThemeList component. It shows a list of all @magic-themes.']), GitBadges('magic-modules/theme-list'), h2({
      id: 'installation'
    }, 'installation'), Pre('npm install @magic-modules/theme-list'), h2({
      id: 'usage'
    }, 'usage'), p('in a page or module View'), Pre('export const View = () => ThemeList()'), h2({
      id: 'demo'
    }, 'demo'), p('this is what it looks like'), ThemeList(), h2({
      id: 'source'
      ...
      to: 'https://github.com/magic/core'
    }, '@magic/core')]), LightSwitch(state)];
  },
  '/theme-list/404/': function themeList404() {
